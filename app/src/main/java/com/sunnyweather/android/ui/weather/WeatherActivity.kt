...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.weatherLiveData.observe(this, Observer { result->
            ...
            if(weather!=null){
                showWeatherInfo(weather)//展示天气信息
            }else{
...
//        viewModel.refreshWeather(viewModel.locationLng,viewModel.locationLat)//初始刷新天气的请求
    ...
    private fun  showWeatherInfo(weather: Weather){
        ...
        val currentTempText = "${realtime.temperature.toInt()} ℃"//天气信息
        ...
        for(i in 0 until days){
            ...
            val view = LayoutInflater.from(this).inflate(R.layout.forecast_item, forecastLayout, false)//forecast为其父布局
